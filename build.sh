...
USER_APPS=("test" "edit" "geditor" "asmc" "dasm" "grep" "cat" "uld" "scc" "explorer" "cp" "mv" "touch" "tree" "ld" "paint" "compositor" "comp_client" "wm" "ush" "term" "ps" "time" "neofetch" "ls" "rm" "mkdir" "kill")
