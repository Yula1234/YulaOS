...
const uint8_t font8x16_basic[128][16] = {
    ...
    [48] = {0x00,0x00,0x3c,0x66,0x6e,0x7e,0x76,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 0
    [49] = {0x00,0x00,0x18,0x38,0x18,0x18,0x18,0x18,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 1
    [50] = {0x00,0x00,0x3c,0x66,0x06,0x0c,0x18,0x30,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 2
    [51] = {0x00,0x00,0x3e,0x06,0x06,0x1e,0x06,0x06,0x3e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 3
    [52] = {0x00,0x00,0x06,0x0e,0x1e,0x36,0x7e,0x06,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 4
    [53] = {0x00,0x00,0x7e,0x60,0x60,0x7c,0x06,0x06,0x7c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 5
    [54] = {0x00,0x00,0x1c,0x30,0x60,0x7c,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 6
    [55] = {0x00,0x00,0x7e,0x06,0x0c,0x18,0x30,0x30,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 7
    [56] = {0x00,0x00,0x3c,0x66,0x66,0x3c,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 8
    [57] = {0x00,0x00,0x3c,0x66,0x66,0x3e,0x06,0x0c,0x38,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // 9
    ...
    [66] = {0x00,0x00,0xfc,0x66,0x66,0x7c,0x66,0x66,0x66,0xfc,0x00,0x00,0x00,0x00,0x00,0x00}, // B
    [67] = {0x00,0x00,0x3c,0x66,0x60,0x60,0x60,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // C
    [68] = {0x00,0x00,0xf8,0x6c,0x66,0x66,0x66,0x6c,0xf8,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // D
    [69] = {0x00,0x00,0x7e,0x60,0x60,0x78,0x60,0x60,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // E
    [70] = {0x00,0x00,0x7e,0x60,0x60,0x78,0x60,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // F
    [71] = {0x00,0x00,0x3c,0x66,0x60,0x6e,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // G
    [72] = {0x00,0x00,0x66,0x66,0x66,0x7e,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00}, // H
    [73] = {0x00,0x00,0x3c,0x18,0x18,0x18,0x18,0x18,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // I
    [74] = {0x00,0x00,0x1e,0x06,0x06,0x06,0x06,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // J
    [75] = {0x00,0x00,0x66,0x6c,0x78,0x70,0x78,0x6c,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00}, // K
    [76] = {0x00,0x00,0x60,0x60,0x60,0x60,0x60,0x60,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // L
    [77] = {0x00,0x00,0x63,0x77,0x7f,0x6b,0x63,0x63,0x63,0x63,0x00,0x00,0x00,0x00,0x00,0x00}, // M
    [78] = {0x00,0x00,0x66,0x6e,0x76,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00}, // N
    [79] = {0x00,0x00,0x3c,0x66,0x66,0x66,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // O
    [80] = {0x00,0x00,0xfc,0x66,0x66,0x7c,0x60,0x60,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00}, // P
    [81] = {0x00,0x00,0x3c,0x66,0x66,0x66,0x66,0x3c,0x0e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // Q
    [82] = {0x00,0x00,0xfc,0x66,0x66,0x7c,0x78,0x6c,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00}, // R
    [83] = {0x00,0x00,0x3c,0x66,0x60,0x3c,0x06,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // S
    [84] = {0x00,0x00,0x7e,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00}, // T
    [85] = {0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // U
    [86] = {0x00,0x00,0x66,0x66,0x66,0x66,0x66,0x3c,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // V
    [87] = {0x00,0x00,0x63,0x63,0x63,0x6b,0x7f,0x77,0x63,0x63,0x00,0x00,0x00,0x00,0x00,0x00}, // W
    [88] = {0x00,0x00,0x66,0x66,0x3c,0x18,0x3c,0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00}, // X
    [89] = {0x00,0x00,0x66,0x66,0x66,0x3c,0x18,0x18,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00}, // Y
    [90] = {0x00,0x00,0x7e,0x06,0x0c,0x18,0x30,0x60,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // Z
    ...
    [95] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0x00,0x00,0x00,0x00,0x00,0x00}, // _
    [96] = {0x00,0x18,0x0c,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // `
    [97] = {0x00,0x00,0x00,0x00,0x3c,0x06,0x3e,0x66,0x3e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // a
    [98] = {0x00,0x00,0x60,0x60,0x7c,0x66,0x66,0x66,0x7c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // b
    [99] = {0x00,0x00,0x00,0x00,0x3c,0x60,0x60,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // c
    [100]= {0x00,0x00,0x06,0x06,0x3e,0x66,0x66,0x66,0x3e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // d
    [101]= {0x00,0x00,0x00,0x00,0x3c,0x66,0x7e,0x60,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // e
    [102]= {0x00,0x00,0x1c,0x30,0x78,0x30,0x30,0x30,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // f
    [103]= {0x00,0x00,0x00,0x00,0x3e,0x66,0x66,0x3e,0x06,0x3c,0x00,0x00,0x00,0x00,0x00,0x00}, // g
    [104]= {0x00,0x00,0x60,0x60,0x7c,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // h
    [105]= {0x00,0x00,0x18,0x00,0x38,0x18,0x18,0x18,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // i
    [106]= {0x00,0x00,0x06,0x00,0x06,0x06,0x06,0x06,0x06,0x3c,0x00,0x00,0x00,0x00,0x00,0x00}, // j
    [107]= {0x00,0x00,0x60,0x60,0x66,0x6c,0x78,0x6c,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // k
    [108]= {0x00,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // l
    [109]= {0x00,0x00,0x00,0x00,0x66,0x7f,0x7f,0x6b,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // m
    [110]= {0x00,0x00,0x00,0x00,0x7c,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // n
    [111]= {0x00,0x00,0x00,0x00,0x3c,0x66,0x66,0x66,0x3c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // o
    [112]= {0x00,0x00,0x00,0x00,0x7c,0x66,0x66,0x7c,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00}, // p
    [113]= {0x00,0x00,0x00,0x00,0x3e,0x66,0x66,0x3e,0x06,0x06,0x00,0x00,0x00,0x00,0x00,0x00}, // q
    [114]= {0x00,0x00,0x00,0x00,0x7c,0x66,0x60,0x60,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // r
    [115]= {0x00,0x00,0x00,0x00,0x3e,0x60,0x3c,0x06,0x7c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // s
    [116]= {0x00,0x00,0x30,0x30,0x7c,0x30,0x30,0x30,0x1c,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // t
    [117]= {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x66,0x3e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // u
    [118]= {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x3c,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // v
    [119]= {0x00,0x00,0x00,0x00,0x63,0x6b,0x7f,0x7f,0x36,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // w
    [120]= {0x00,0x00,0x00,0x00,0x66,0x3c,0x18,0x3c,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // x
    [121]= {0x00,0x00,0x00,0x00,0x66,0x66,0x66,0x3e,0x06,0x3c,0x00,0x00,0x00,0x00,0x00,0x00}, // y
    [122]= {0x00,0x00,0x00,0x00,0x7e,0x0c,0x18,0x30,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // z
    ...
    [127]= {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // del (unused)
};
